...
sets = ['train', 'test','val']
classes = ['turn left','turn right','turn left or right','stay now']
...
def convert_annotation(image_id):
    in_file = open('VOCData/Annotations/%s.xml' % (image_id))
...
for image_set in sets:
    ...
    image_ids = open('VOCData/ImageSets/%s.txt' % (image_set)).read().strip().split()
